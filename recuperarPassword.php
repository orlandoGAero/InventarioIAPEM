		...
		<script type='text/javascript'>
			$(function (e) {
				$('#repass').submit(function (e) {
					e.preventDefault()
					$('#ajax').load('enviarPass2.php?' + $('#repass').serialize())
				})
			})
		</script>
	</head>
		...
		<div id = "contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha">				
					...
					?>
					<center>
						<fieldset><legend>Recuperar password</legend>
							<form name='repass' action='' method='POST' id='repass' target='_self'>
								<ul>
									<li>
										<label>Ingresa el usuario: <font color='#FF0000'>*</font></label>
									</li>
									<li>
										<input type='text' name='nomUser' size='30' class='rounded'/><br/>
									</li>
