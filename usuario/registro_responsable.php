	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha4">
					<div id="botones_sec">
						<a href="registro_responsable.php"><img src='../imagenes/nuevo.png' ALT="Nuevo Registro" TITLE="Nuevo Registro" vspace=4 hspace=4/></a>
					</div>
					
					<center>
						<fieldset><legend>Registro de Responsable</legend>
							<form name='altaR' action='' method='POST' id='altaR' target='_self'>
								<ul>
									<li>
									...
									<li>	
										<?php
											include '../librerias/conexion.php';
											$consulta = 'SELECT IDresguardatario FROM resguardatarios ORDER BY IDresguardatario DESC LIMIT 1';
											$ejecutar = mysql_query($consulta) or die (mysql_error());
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='ap' size='30' class='rounded' onKeyUp='letras(this.value,apa);'/>	
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='am' size='30' class='rounded' onKeyUp='letras(this.value,ama);'/>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='cargo' size='30' class='rounded' onKeyUp='letras(this.value,ca);'/>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='telP' size='30' class='rounded' onKeyUp='tel(this.value,tp);'>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='telI' size='30' class='rounded' onKeyUp='ext(this.value,ex);'>
												</td>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#altaR').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('registro_responsable2.php?' + $('#altaR').serialize())
							})
						})
					</script>
