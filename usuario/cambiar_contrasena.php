				...
				<div id="derecha">
					...
					<center>
						<fieldset><legend>Cambiar Contraseña</legend>
							<form name='cambiarcontra' action='' method='POST' id='cambiarcontra' target='_self'>
								<ul>
									<li>
										<label>Nueva contraseña: <font color='#FF0000'>*</font></label>
									</li>
									<li>
											<input type='password' name='nuevaCont' size='30' class='rounded'/>	
									</li>
									...
									<li>
											<input type='password' name='confirmarCont' size='30' class='rounded'/>	
									</li>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#cambiarcontra').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('cambiar_contrasena2.php?' + $('#cambiarcontra').serialize())
							})
						})
					</script>
				</div>
