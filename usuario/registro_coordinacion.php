...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Registrar Coordinación</title>
	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha">
					<div id="botones_sec">
						<a href="registro_coordinacion.php"><img src='../imagenes/nuevo.png' ALT="Nuevo Registro" TITLE="Nuevo Registro" vspace=4 hspace=4/></a>
					</div>
					
					<center>
						<fieldset><legend>Registro de Coordinación</legend>
							<form name='altaCo' action='' method='POST' id='altaCo' target='_self'>
								<ul>
									<li>
									...
									<li>
										<?php
											include '../librerias/conexion.php';
											$consulta = 'SELECT IDcoordinacion FROM coordinaciones ORDER BY IDcoordinacion DESC LIMIT 1';
											$ejecutar = mysql_query($consulta) or die (mysql_error());
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='nomCo' size='30' class='rounded' onKeyUp='letras(this.value,nomC);'>	
												</td>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#altaCo').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('registro_coordinacion2.php?' + $('#altaCo').serialize())
							})
						})
					</script>
				</div>
