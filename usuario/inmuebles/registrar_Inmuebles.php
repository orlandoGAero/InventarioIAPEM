		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha3">
					...
					<center>
						<fieldset><legend>Registro de Inventario Bienes Inmuebles</legend>
							<form name='altaInm' action='registrar_Inmuebles2.php' method='POST'>
								<ul>
									<li>
									...
									<li>
										<?php
											include '../../librerias/conexion.php';
											$consulta = "SELECT IDinmueble FROM bienes_inmuebles ORDER BY IDinmueble DESC LIMIT 1";
											$ejecutar = mysql_query($consulta) or die (mysql_error());
											$filas = mysql_num_rows($ejecutar);
												...
												{
													$idInm = mysql_result($ejecutar,0,'IDinmueble');
													$idInm = $idInm+1;
												}
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='nomInm' size='30' class='rounded' onKeyUp='letras(this.value,nomI);'>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='calle' size='30' class='rounded' onKeyUp='dire(this.value,ca);'>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='numer' size='30' class='rounded' onKeyUp='num(this.value,no);'>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='col' size='30' class='rounded' onKeyUp='dire(this.value,co);'>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='cp' size='30' class='rounded' onKeyUp='codpo(this.value,cdpo);'>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='ciudad' size='30' class='rounded' onKeyUp='cdad(this.value,nomC);'>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='tel' size='30' class='rounded' onKeyUp='telef(this.value,te);'>
												</td>
									...
									<li>
										<?php
											$consultaR = "SELECT IDresguardatario,nombre,ap_paterno,ap_materno FROM resguardatarios WHERE activo='Si' ORDER BY nombre";
									...
									<li>
										<?php
											$consultaE = "SELECT IDest_adq,tipo FROM estado_adquisicion ORDER BY tipo";
											$ejecutarE = mysql_query($consultaE) or die (mysql_error());
											$filasE = mysql_num_rows($ejecutarE);
											echo"<select name='idE' class='select'><option selected>Seleccione...</option>";
												for($y=0;$y<$filasE;$y++)
												{
													$idE = mysql_result($ejecutarE,$y,'IDest_adq');
													$tipo = mysql_result($ejecutarE,$y,'tipo');
													echo"<option value='$idE'>$tipo</option>";
												}
										?>
												</select>
									</li>
