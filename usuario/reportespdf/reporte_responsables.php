		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha4">
					...
					<h1><font size='4' face='Georgia' color = 'red'><b>REPORTE DE REGUARDO</b></font></h1>

					<center>
						<fieldset><legend> Generar Resguardo</legend>
							<form name = 'Sresp' id = 'Sresp' action = '' method = 'POST' target = '_self'>
								...
								<ul>
									...
									<?php
											...
											$consultaR = "SELECT IDresguardatario,nombre,ap_paterno,ap_materno FROM resguardatarios";
											$ejecutarR = mysql_query($consultaR) or die (mysql_error());
											$filasR = mysql_num_rows($ejecutarR);
											echo"<select name='IDreguardatario' class = 'select' style = 'width: 300px;' id = 'IDreguardatario' >
					...
					<script type="text/javascript">
						$(function (e) {
						$('#IDreguardatario').change(function (e) {
						$('#result').load('generar_reguardo.php?IDreguardatario=' + this.options[this.selectedIndex].value)
							})
						})
					</script>
