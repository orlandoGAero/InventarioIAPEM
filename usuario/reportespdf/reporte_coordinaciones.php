...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Reporte Coordinación</title>
		...
		<div id="contenedor">
			...
			<div id="cssmenu">
				<ul class="menu">
					...
					<li class='has-sub'><a href="#">Reportes</a>
						<ul>
							<li><a href="reporte_responsables.php">Responsable</a></li>
							<li><a href="reporte_coordinaciones.php">Coordinación</a></li>
						</ul>
					</li>
			...
			<div id="contenido">
				...
				<div id="derecha4">
					...
					<h1><font size='4' face='Georgia' color = 'red'><b>REPORTE DE COORDINACIÓN</b></font></h1>

					<center>
						<fieldset><legend> Generar Reporte</legend>
							<form name = 'Sresp' id = 'Sresp' action = '' method = 'POST' target = '_self'>

								<ul>
									<li>
									<label> Selecciona Coordinación: </label>
									...
									<?php
											...
											echo" <select name='IDcoordinacion' class = 'select' style = 'width: 300px;' id = 'IDcoordinacion' >
					...
					<script type="text/javascript">
						$(function (e) {
						$('#IDcoordinacion').change(function (e) {
						$('#result').load('reporte_coordinacion.php?IDcoordinacion=' + this.options[this.selectedIndex].value)
							})
						})
					</script>
