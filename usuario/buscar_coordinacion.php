...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Buscar Coordinación</title>
	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha4" class='tamBusquedad'>
					<center>
						<fieldset><legend>Búsqueda de Coordinación</legend>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#crit').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('buscar_coordinacion2.php?' + $('#crit').serialize())
							})
						})
					</script>
				</div>
