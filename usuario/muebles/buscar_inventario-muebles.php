...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Buscar Inventario Bienes Muebles</title>
			...
			<div id="contenido">
				...
				<div id="derecha4">
					<div id="botones_sec">
						...
						<a href="mostrar_inv-mueb-baja.php"><img src='../../imagenes/bajaInv.png' ALT="Mostar" TITLE="Mostrar baja inventario" vspace=4 hspace=4/></a>
						<a href="inventario_Bmuebles.php"><img src='../../imagenes/icono_tabla.png' ALT="Mostrar todo" TITLE="Mostrar todo" vspace=4 hspace=4/></a>
					</div>
					
					<center>
						<fieldset><legend>Búsqueda de Inventario Bienes Muebles</legend>
							<form name = 'buscar' action = '' method = 'POST' class="formulariodemo1 cf">
							  <input type = "text" placeholder = " Ingresar criterio ..." required name = 'crit' method = 'POST'
							  onkeyup="new Ajax.Updater('ajax','buscar_inventario-muebles2.php?buscar='+this.value, {method: 'POST' })">
