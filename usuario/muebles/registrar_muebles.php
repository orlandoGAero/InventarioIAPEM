...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Registrar Bienes Muebles</title>
		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<center>
						<fieldset><legend>Registro de Bienes Muebles</legend>
							<form name='altaM' action='' method='POST' id='altaM' target='_self'>
								<ul>
									<li>
									...
									<li>
										<?php
											include '../../librerias/conexion.php';
											$consulta = 'SELECT IDmueble FROM muebles ORDER BY IDmueble DESC LIMIT 1';
											$ejecutar = mysql_query($consulta) or die (mysql_error());
											$filas = mysql_num_rows($ejecutar);
												...
												{
													$idM = mysql_result($ejecutar,0,'IDmueble');
													$idM = $idM+1;
												}
												
											echo"<input type='text' name='idM' value='$idM' size='30' readonly='readonly' size='30' class = 'rounded'>";
										?>				
									</li>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<input type='text' name='nomM' size='30' class='rounded' onKeyUp='nomInm(this.value,art);'>	
												</td>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#altaM').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('registrar_muebles2.php?' + $('#altaM').serialize())
							})
						})
					</script>
				</div>
