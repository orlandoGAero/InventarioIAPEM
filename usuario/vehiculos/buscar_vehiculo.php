		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<!-- Fin de menú -->
					...
					<center>
						<fieldset><legend>Búsqueda de Vehiculo</legend>
							<form name = 'buscar' action = '' method = 'POST' class="formulariodemo1 cf 1">
							  <input type = "text" placeholder = " Ingresar criterio ..." required name = 'crit'
							  onkeyup="new Ajax.Updater('ajax','buscar_vehiculo2.php?buscar='+this.value, {method: 'POST' })">
							</form>
						</fieldset>
					</center>
