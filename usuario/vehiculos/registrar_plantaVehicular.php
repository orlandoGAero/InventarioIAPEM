...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Registrar Planta Vehícular</title>
		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha2">
					...
					<div id="botones_sec">
						<a href="registrar_plantaVehicular.php"><img src='../../imagenes/addvehiculo.png' ALT="Nuevo Registro" TITLE="Nuevo Registro" vspace=4 hspace=4/></a>
						<a href="registrar_servicio.php"><img src='../../imagenes/addservicio.png' ALT="Nuevo Registro" TITLE="Nuevo Registro" vspace=4 hspace=4/></a>
					</div>
					
					<!--Inicio de formulario-->
					
					<center>
						<fieldset><legend>Registro de Inventario Planta Vehícular</legend>
							<form name = 'altaPvehi' action = '' method = 'POST' id = 'altaPvehi' target = '_self'>
								<ul>
							        ...
							        <li>
							        	<?php
							        		...
							        		$consultaI = "SELECT IDinmueble,nombre_sede FROM bienes_inmuebles";
									...
									<li>	
										<?php
											$consultaC = "SELECT IDcoordinacion,coordinacion FROM coordinaciones";
									...
									<li>
										<?php
											$consultaR = "SELECT *  FROM resguardatarios";
											...
											echo"<select name = 'idR' class = 'select'><option selected>Seleccione...</option>";
												for($y=0;$y<$filasR;$y++)
												{
													...
													$am = utf8_encode($am);
													$cargo = mysql_result($ejecutarR,$y,'cargo');
													$cargo = utf8_encode($cargo);
													$activo = mysql_result($ejecutarR,$y,'activo');
													$activo = utf8_encode($activo);
													$IDusuario = mysql_result($ejecutarR,$y,'IDusuario');
													$IDusuario = utf8_encode($IDusuario);
													$fechamod = mysql_result($ejecutarR,$y,'fecha_mod');
													$fechamod = utf8_encode($fecha_mod);
									...
									<li>
										<input type = 'text' name = 'fecha' size = '30' class = 'ancho date rounded calend'>		
									</li>
									...
									<li>
										<table border = '0' align='left'>
											<tr>
												<td>
													<input type = 'text' name = 'nuevoCod' size = '30' class = 'rounded' OnKeyUp = 'codnuevo(this.value,codN)'>
												</td>
												<td id = 'codN' width = '22'>  </td>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'anteriorCod' size = '30' class = 'rounded' OnKeyUp = 'codanterior(this.value,codA)'>
												</td>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'modelo' size = '30' class = 'rounded' >
												</td>
												<td>  </td>
											</tr>
										</table>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'marca' size = '30' class = 'rounded' onKeyUp = 'automarca(this.value,marc)'>
												</td>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'colorVe' size = '30' class = 'rounded' onKeyUp = 'color(this.value,colorV)'>
												</td>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'placas' size = '30' class = 'rounded' onKeyUp = 'placasV(this.value,pla)'>
												</td>
												<td id = 'pla' width = '22'>  </td>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'noserie' size = '30' class = 'rounded' OnKeyUp = 'vin(this.value,serie)'>
												</td>
												<td id = 'serie' width = '22'>  </td>
											</tr>
										</table>
									</li>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'ano' size = '30' class = 'rounded' maxlength = '4' onKeyUp = 'year(this.value,anos)'/>
												</td>
												<td id = 'anos' width = '22'>  </td>
											</tr>
										</table>
									</li>
									...
									<li>
										<input type = 'text' name = 'fecha_ultima_v' size = '30' class = 'ancho date rounded calend'>		
									</li>
									...
									<li>
										<input type = 'text' name = 'fecha_proxima_v' size = '30' class = 'ancho date rounded calend'>		
									</li>
									...
									<li>
										<input type = 'text' name = 'fecha_ultima_t' size = '30' class = 'ancho date rounded calend'>		
									</li>
									...
									<li>
										<input type = 'text' name = 'fecha_proxima_t' size = '30' class = 'ancho date rounded calend'>		
									</li>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'tarjeta' size = '30' class = 'rounded'>
												</td>
												<td>  </td>
											</tr>
										</table>
									...
									<li>
										<table border = '0' align = 'left'>
											<tr>
												<td>
													<input type = 'text' name = 'tipo_v' size = '30' class = 'rounded' onKeyUp = 'autotipo(this.value,tipo)'>
												</td>
												<td id = 'tipo' width = '22'>  </td>
					...
					<script type="text/javascript">
						$(function (guardar) {
							$('#altaPvehi').submit(function (guardar) {
								guardar.preventDefault()
								$('#ajax').load('registrar_plantaVehicular2.php?' + $('#altaPvehi').serialize())
							})
						})
					</script>
				</div>
