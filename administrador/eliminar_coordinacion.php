...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Eliminar Coordinación</title>
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						...
						if($band == 0)
						{
							$consulta = "SELECT * FROM coordinaciones WHERE IDcoordinacion=$idCo";
							$ejecutar = mysql_query($consulta) or die (mysql_error());
						...
						if($band == 0)
						{
							 $consulta2 = "DELETE coordinaciones FROM coordinaciones WHERE IDcoordinacion=$idCo";
							 $ejecutar2 = mysql_query($consulta2) or die (mysql_error());
							 echo "Registro eliminado correctamente <br/>";
						}
						else
						{
							$consulta3 = "SELECT activo FROM coordinaciones WHERE IDcoordinacion=$idCo";
							$ejecutar3 = mysql_query($consulta3) or die (mysql_error());
							$activo = mysql_result($ejecutar3,0,'activo');
							
							if($activo=='Si')
							{
								$consulta4 = "UPDATE coordinaciones SET activo='No' WHERE IDcoordinacion=$idCo";
