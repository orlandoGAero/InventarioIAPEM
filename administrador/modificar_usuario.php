			...
			<div id="contenido">
				...
				<div id="izquierda10">
					...
					<div id="derecha10">
						...
						<div id="botones_sec">
							<a href="buscar_usuario.php"><img src='../imagenes/back.png' ALT="Regresar" TITLE="Regresar" vspace=4 hspace=4/></a>						
						</div>
						...
						<?php
						 ...
						 require_once('../librerias/recaptchalib.php');
  						...
  						$idu = mysql_real_escape_string(quitar($_GET['IDusuario']));

  						/*consulta para obtener el nombre de usuario que realizo la última modificación*/
							$consultaUs = "SELECT nombre,appat,ammat,fecha_mod
										   FROM usuarios
										   WHERE IDusuario='$idu' ";
						...
						$consultMod = " SELECT *
										FROM usuarios
										WHERE IDusuario = $idu ";
						$ejecutarMod = mysql_query($consultMod) or die (mysql_error());

						$idu = mysql_result($ejecutarMod, 0, 'IDusuario');
						$nom = mysql_result($ejecutarMod, 0, 'nombre');
							$nom = utf8_encode($nom);
						$appat = mysql_result($ejecutarMod, 0, 'appat');
							$appat = utf8_encode($appat);
						$ammat = mysql_result($ejecutarMod, 0, 'ammat');
							$ammat = utf8_encode($ammat);
						$correo = mysql_result($ejecutarMod, 0, 'correo');
							$correo = utf8_encode($correo);
						$usuario =  mysql_result($ejecutarMod, 0, 'usuario');
							$usuario = utf8_encode($usuario);
						$tipo = mysql_result($ejecutarMod, 0, 'tipo');
						$activo = mysql_result($ejecutarMod, 0, 'activo');
 						?>

						<center>
							<fieldset><legend> Modificar Usuario</legend>
								<form name = 'modUser' id = 'modUser' action = '' method = 'POST' target = '_self'>
									...
									<ul>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'IDu' <?php echo " value = '$idu' "; ?> readonly = 'readonly' size = '30' class = 'rounded' />
													</td>
												</tr>
											</table>
										</li>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'nombre' <?php echo " value = '$nom' "; ?> size = '30' class = 'rounded' onKeyUp = 'letras(this.value,nom)'>
													</td>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'ap_paterno' <?php echo " value = '$appat' "; ?> size = '30' class = 'rounded' onKeyUp = 'letras(this.value,ap)'>
													</td>
													<td id = 'ap' width = '22'>  </td>
												</tr>
											</table>
										</li>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'ap_materno' <?php echo " value = '$ammat' "; ?> size = '30' class = 'rounded' onKeyUp = 'letras(this.value,am)'>
													</td>
													<td id = 'am' width = '22'>  </td>
												</tr>
											</table>
										</li>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'correo' <?php echo " value = '$correo' "; ?> size = '30' class = 'rounded' onKeyUp = 'email(this.value,mail)' >
													</td>
													<td id = 'mail' width = '22'>  </td>
												</tr>
											</table>
										</li>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'usuario' <?php echo " value = '$usuario' "; ?> size = '30' class = 'rounded' >
													</td>
												</tr>
											</table>
										</li>
									...
									<?php
											if ($tipo == 'ADMINISTRADOR')
											{
												...
												echo "<li>
											        ...
											        <li class='radio' >
															Administrador <input type = 'radio' name = 'tipo' value = 'ADMINISTRADOR' checked>
											                Usuario <input type = 'radio' name = 'tipo' value = 'USUARIO'>
											        </li> ";
														...
														echo " 	<li>
														        ...
														        <li class='radio' >
																		Administrador <input type = 'radio' name = 'tipo' value = 'ADMINISTRADOR'>
								        ...
								        <li>
											<input type = 'submit' name = 'mod' value = 'Modificar' class = 'boton rounded1'>
										</li>
						...
						<script type = "text/javascript">
							$(function (modificar) {
								$('#modUser').submit(function (modificar) {
									modificar.preventDefault()
									$('#ajax').load('modificar_usuario2.php?' + $('#modUser').serialize())
								})
							})
						</script>
