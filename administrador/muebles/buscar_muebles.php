...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Buscar Bienes Muebles</title>
		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha4">
					...
					<center>
						<fieldset><legend>Búsqueda de Bienes Muebles</legend>
							<form name = 'crit' action = '' method = 'POST' id = 'crit' target = '_self' class="formulariodemo cf">
					...
					<script type="text/javascript">
						$(function (e) {
							$('#crit').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('buscar_muebles2.php?' + $('#crit').serialize())
							})
						})
					</script>
				</div>
