...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Inventario Bienes Muebles </title>
	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha4">
					<div id="botones_sec">
						<a href="buscar_muebles.php"><img src='../../imagenes/bmueble.png' ALT="Buscar Artículo" TITLE="Buscar Artículo" vspace=4 hspace=4/></a>
						<a href="buscar_inventario-muebles.php"><img src='../../imagenes/Buscarinventario.png' ALT="Inventario" TITLE="Buscar Inventario" vspace=4 hspace=4/></a>
						<a href="mostrar_inv-mueb-baja.php"><img src='../../imagenes/bajaInv.png' ALT="Baja bienes muebles" TITLE="Baja Bienes Muebles" vspace=4 hspace=4/></a>
						<a href="inventario_Bmuebles.php"><img src='../../imagenes/icono_tabla.png' ALT="Mostrar todo" TITLE="Mostrar todo" vspace=4 hspace=4/></a>
					</div>
					...
					<?php
						...
						$consulta = "SELECT bm.codigoNuevoM,bm.codigoAnterior,bm.fecha_ingreso,bm.activo,bm.area_ubicacion,bm.caracteristicas,m.nombre,bi.nombre_sede,c.coordinacion,r.nombre as nomR,r.ap_paterno,r.ap_materno
									...
									WHERE bm.activo='Si' AND m.IDmueble=bm.IDmueble AND c.IDcoordinacion=bm.IDcoordinacion AND r.IDresguardatario=bm.IDresguardatario AND bi.IDinmueble=bm.IDinmueble";
						$ejecutar = mysql_query($consulta) or die (mysql_error());
						$filas = mysql_num_rows($ejecutar);
							...
							{
								echo"<br/><br/><font size='3' face='Georgia'><b>INVENTARIO BIENES MUEBLES</b></font><br/><br/>";
								echo "<div id='icon_excel'><a href='../../excel/admin/exl_todo_bmuebles.php'><img src='../../imagenes/excel2013.png' TITLE='Ver Excel'/></a></div>";
								echo"<center>
