...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Modificar Bienes Muebles</title>
	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha6">
					<div id="botones_sec">
						<a href="buscar_muebles.php"><img src='../../imagenes/back.png' ALT="Regresar" TITLE="Regresar" vspace=4 hspace=4/></a>
					</div>
					...
					<?php
						...
						$idM = mysql_real_escape_string(quitar($_GET['IDmueble']));
						
						/*consulta para obtener el nombre de usuario que realizo la última modificación*/
						$consultaUs = "SELECT u.nombre,u.appat,u.ammat,m.fecha_mod
									   FROM muebles AS m,usuarios AS u
									   WHERE m.IDmueble=$idM AND m.IDusuario=u.IDusuario";
						...
						/*--*/
						$consulta2 = "SELECT IDmueble,nombre,activo FROM muebles WHERE IDmueble = '$idM'";
						$ejecutar2 = mysql_query($consulta2) or die (mysql_error());
						
						$idM = mysql_result($ejecutar2,0,'IDmueble');
						$nomM = mysql_result($ejecutar2,0,'nombre');
						$nomM = utf8_decode($nomM);
						$activo = mysql_result($ejecutar2,0,'activo');
					?>				
					
					<center>
						<fieldset><legend>Modificación de Bienes Muebles</legend>
							<form name='modM' action='' method='POST' id='modM' target='_self'>
								<ul>
									<li>
										<label>Clave de Mueble:</label>
									</li>
									<li>
										<?php
											echo"<input type='text' name='idM' value='$idM' readonly='readonly' size='30' class = 'rounded'>";
										?>				
									</li>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<?php
														echo"<input type='text' name='nomM' value='$nomM' size='30' class='rounded' onKeyUp='nomInm(this.value,art)'>";
													?>
												</td>
												<td id='art' width='22'>  </td>
												<td> <a class = "tooltip" > <font size = '4' color = '#0000FF'>(?)</font> <span class="custom help"> <img src = "../../imagenes/Help.png" alt = "Help" height="35" width="35" />Ingresa el nombre del artículo, por ejemplo: </br> -Escritorio<br> -Sillón</span></a></td>
											</tr>
										</table>
									</li>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#modM').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('modificar_mueble2.php?' + $('#modM').serialize())
							})
						})
					</script>
				</div>
