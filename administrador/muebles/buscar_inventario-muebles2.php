<?php
	...
	if($_REQUEST['buscar'])
	{
		...
		$cri = encode("crit=$crit");
			...
			{
				echo "<div id='icon_excel'><a href='../../excel/admin/exl_inventario-muebles.php?$cri'><img src='../../imagenes/excel2013.png' TITLE='Ver Excel'/></a></div>";
				echo "<center>
						<table border = '0' id ='miTabla'>
							...
							for($y=0;$y<$filas;$y++)
							{
								...
								echo "<tr>
										...
										<td>$activo</td>
										<td>
											<a href='modificar_inventario-muebles.php?$g'><img src='../../imagenes/editar.png' TITLE='Modificar' /></a>
											<a href='eliminar_inventario-muebles.php?$h'><img src='../../imagenes/delete.png' TITLE='Eliminar'/></a>
										</td>
									 </tr>";
							}
