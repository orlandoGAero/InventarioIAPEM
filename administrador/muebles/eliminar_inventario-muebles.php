			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						...
						$consulta = "SELECT activo FROM bienes_muebles WHERE codigoNuevoM='$codigoNuevoM'";
						$ejecutar = mysql_query($consulta) or die (mysql_error());
						...
						{
							echo"<center>
									<fieldset><legend>Eliminar o  Desactivar Inventario Bienes Muebles</legend>
										<form action='eliminar_inventario-muebles2.php' method='POST'>
											<ul>
												<li>
													<input type='hidden' name='codigoNuevoM' value='$codigoNuevoM'/>
												</li>
