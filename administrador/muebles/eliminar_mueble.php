...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Eliminar Bienes Muebles</title>
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						...
						if($band == 0)
						{
							$consulta = "SELECT * FROM muebles WHERE IDmueble=$idM";
							$ejecutar = mysql_query($consulta) or die (mysql_error());
							$filas = mysql_num_rows($ejecutar);
							if($filas !=0)
							{
								echo"<br/> <font size='4' face='time new roman' text color='#FF8000'>No se puede eliminar el registro...porque es utilizado por otra tabla </font> <br/>";
								$band = 1;
							}
						}
