...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Eliminar Inventario Bienes Muebles</title>
		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						include '../../librerias/conexion.php';
						$codigoNuevoM = $_POST['codigoNuevoM'];
						...
						else
						{
							if($band == 0)
							{
							$consulta = "SELECT * FROM bienes_muebles WHERE codigoNuevoM='$codigoNuevoM'";
							$ejecutar = mysql_query($consulta) or die (mysql_error());
							...
							if($band == 0)
							{
								 $consulta2 = "DELETE FROM bienes_muebles WHERE codigoNuevoM='$codigoNuevoM";
							...
							else
							{
								...
								$consulta = "UPDATE bienes_muebles SET motivo_baja='$motBaja',activo='No' WHERE codigoNuevoM='$codigoNuevoM'";
								$ejecutar = mysql_query($consulta) or die (mysql_error());
