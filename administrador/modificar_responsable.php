...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		...
		<script type="text/javascript" src="../librerias/validacion.js"></script>
		<?php @session_start();
	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha8">
					<div id="botones_sec">
						<a href="buscar_responsable.php"><img src='../imagenes/back.png' ALT="Regresar" TITLE="Regresar" vspace=4 hspace=4/></a>
					</div>
					...
					<?php
						...
						$consultaUs = "SELECT u.nombre,u.appat,u.ammat,r.fecha_mod
									   FROM resguardatarios AS r,usuarios AS u
									   WHERE r.IDresguardatario=$idR AND r.IDusuario=u.IDusuario";
						...
						/*--*/
						$consulta2 = "SELECT IDresguardatario,nombre,ap_paterno,ap_materno,cargo,tel_part,tel_iapem,activo FROM resguardatarios WHERE IDresguardatario = '$idR'";
						$ejecutar2 = mysql_query($consulta2) or die (mysql_error());
						
						$idR = mysql_result($ejecutar2,0,'IDresguardatario');
						$nombre = mysql_result($ejecutar2,0,'nombre');
						$nombre = utf8_encode($nombre);
						$ap = mysql_result($ejecutar2,0,'ap_paterno');
						$ap = utf8_encode($ap);
						$am = mysql_result($ejecutar2,0,'ap_materno');
						$am = utf8_encode($am);
						$cargo = mysql_result($ejecutar2,0,'cargo');
						$cargo = utf8_encode($cargo);
						$telPart = mysql_result($ejecutar2,0,'tel_part');
						$telIAPEM = mysql_result($ejecutar2,0,'tel_iapem');						
						$activo = mysql_result($ejecutar2,0,'activo');
					?>				
					
					<center>
						<fieldset><legend>Modificación de Responsable</legend>
							<form name='modR' action='' method='POST' id='modR' target='_self'>
								<ul>
									<li>
										<label>Clave de Responsable:</label>
									</li>
									<li>	
										<?php
											echo"<input type='text' name='idR' value='$idR' readonly='readonly' size='30' class = 'rounded'>";
										?>				
									</li>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<?php
														echo"<input type='text' name='nombre' value='$nombre' size='30' class='rounded' onKeyUp='letras(this.value,nom)'/>";
													?>
												</td>
												<td id='nom' width='22'></td>
											</tr>
										</table>
									</li>
											
									<li>
										<label>Apellido Paterno: <font color='#FF0000'>*</font></label>
									</li>
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<?php
														echo"<input type='text' name='ap' value='$ap' size='30' class='rounded' onKeyUp='letras(this.value,apa)'/>";
													?>
												</td>
												<td id='apa' width='22'>  </td>
											</tr>
										</table>
									</li>
											
									<li>
										<label>Apellido Materno: <font color='#FF0000'>*</font></label>
									</li>
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<?php
														echo"<input type='text' name='am' value='$am' size='30' class='rounded' onKeyUp='letras(this.value,ama)'/>";
													?>
												</td>
												<td id='ama' width='22'></td>
											</tr>
										</table>
									</li>
											
									<li>
										<label>Cargo: <font color='#FF0000'>*</font></label>
									</li>
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<?php
														echo"<input type='text' name='cargo' value='$cargo' size='30' class='rounded' onKeyUp='letras(this.value,ca)'/>";
													?>
												</td>
									...
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<?php
														echo"<input type='text' name='telP' value='$telPart' size='30' class='rounded' onKeyUp='tel(this.value,tp)'>";
													?>
												</td>
												<td id='tp' width='22'>  </td>
											</tr>
										</table>
									</li>
									
									<li>
										<label>Extensión IAPEM:</label>
									</li>
									<li>
										<table border='0' align='left'>
											<tr>
												<td>
													<?php
														echo"<input type='text' name='telI' value='$telIAPEM' size='30' class='rounded' onKeyUp='ext(this.value,ex);'>";
													?>
												</td>
												<td id='ex' width='22'>  </td>
											</tr>
										</table>
									</li>
									...
									<li class='radio'>	
										<?php
											if($activo=='Si')
											{
												echo"Si<input type='radio' name='activo' value='Si' checked />
													No<input type='radio' name='activo' value='No' />";
											}
											else
											{
												echo"Si<input type='radio' name='activo' value='Si'/>
													No<input type='radio' name='activo' value='No' checked />";
											}
										?>
									</li>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#modR').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('modificar_responsable2.php?' + $('#modR').serialize())
							})
						})
					</script>
				</div>
