			...
			$cri = encode("crit=$crit");
				if($filas==0)
				{
					echo "<script>alert('No exiten registros con el criterio tecleado')</script>";
							...
							echo "<div id='icon_excel'><a href='../excel/admin/exl_responsable.php?$cri'><img src='../imagenes/excel2013.png' TITLE='Ver Excel'/></a></div>";
												...
												for($y=0;$y<$filas;$y++)
												{
													...
													echo   "<script>
															...
															<tr align = 'center'>
																...
																<td> $activo </td>
																<td>
																	<a href='modificar_responsable.php?$c'><img src='../imagenes/editar.png' TITLE='Modificar' /></a>
																	<a href='eliminar_responsable.php?$d'><img src='../imagenes/delete.png' TITLE='Eliminar' onclick='javascript:return asegurar();'/></a>
																</td>
															</tr>";
												}
