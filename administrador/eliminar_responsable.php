			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						...
						if($band == 0)
						{
							$consulta = "SELECT * FROM resguardatarios WHERE IDresguardatario=$idR";
							$ejecutar = mysql_query($consulta) or die (mysql_error());
							$filas = mysql_num_rows($ejecutar);
							if($filas !=0)
							{
								echo"<br/><br/> <font size='4' face='time new roman' text color='#FF8000'>No se puede eliminar el registro...porque es utilizado por otra tabla </font> <br/>";
								$band = 1;
							}
						}
						...
						if($band == 0)
						{
							 $consulta2 = "DELETE resguardatarios FROM resguardatarios WHERE IDresguardatario=$idR";
						...
						{
							$consulta3 = "SELECT activo FROM resguardatarios WHERE IDresguardatario=$idR";
							$ejecutar3 = mysql_query($consulta3) or die (mysql_error());
							$activo = mysql_result($ejecutar3,0,'activo');
							
							if($activo=='Si')
							{
								$consulta4 = "UPDATE resguardatarios SET activo='No' WHERE IDresguardatario=$idR";
								$ejecutar4 = mysql_query($consulta4) or die (mysql_error());
							...
							{
								echo"<img src='../imagenes/advertencia.png' vspace=10/><br/>";
								echo "<br/><font size='5' face='time new roman' text color='#FF8000'>El registro ya fue desactivado anteriormente</font>";
							}
						}
					?>
