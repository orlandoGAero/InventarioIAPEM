	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha4">
					<div id="botones_sec">
						<a href="buscar_usuario.php"><img src='../imagenes/buscarusuario.png' ALT="Buscar Usuario" TITLE="Buscar Usuario" vspace=4 hspace=4/></a>
					</div>

					<center>
						<fieldset><legend>Búsqueda Usuarios</legend>
					...
					<script type="text/javascript">
						$(function (e) {
							$('#crit').submit(function (e) {
								e.preventDefault()
								$('#ajax').load('buscar_usuario2.php?' + $('#crit').serialize())
							})
						})
					</script>
				</div>
