			...
			<div id="contenido">
				...
				<div id="izquierda9">
					...
					<div id="derecha9">
						...
						<div id="botones_sec">
							<a href="registrar_usuario.php"><img src='../imagenes/addusuario.png' ALT="Nuevo Usuario" TITLE="Nuevo Usuario" vspace=4 hspace=4/></a>
						</div>
						...
						<center>
							<fieldset><legend> Registrar Usuarios</legend>
									<script type="text/javascript">
										var RecaptchaOptions = {
										theme : 'red'
										};
									</script>
								<form name = 'altaUser' id = 'altaUser' action = '' method = 'POST' target = '_self'>
									...
									<ul>
												...
												$filas = mysql_num_rows($ejecutar2);
													...
													if ( $filas == 0)
													{
														$idu = 1;
																...
																$idu = mysql_result ($ejecutar2, 0, 'IDusuario');
																$idu = $idu+1;
															}
											?>
										<li>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'nombre' size = '30' class = 'rounded' onKeyUp = 'letras(this.value,nom)'>
													</td>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'ap_paterno' size = '30' class = 'rounded' onKeyUp = 'letras(this.value,ap)'>
													</td>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'ap_materno' size = '30' class = 'rounded' onKeyUp = 'letras(this.value,am)'>
													</td>
										...
										<li>
											<label> Correo Electrónico: <font color='#FF0000'>*</font> </label>
										</li>
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'correo' size = '30' class = 'rounded' onKeyUp = 'email(this.value,mail)' >
													</td>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'text' name = 'usuario' size = '30' class = 'rounded' >
													</td>
												</tr>
											</table>
										</li>
										...
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'password' name = 'psw' size = '30' class = 'rounded' >
													</td>
												</tr>
											</table>
										</li>
										...
										<li>
											<label> Confirmar Contraseña <font color='#FF0000'>*</font> </label>
										</li>
										<li>
											<table border = '0' align = 'left'>
												<tr>
													<td>
														<input type = 'password' name = 'conpsw' size = '30' class = 'rounded' >
													</td>
												</tr>
											</table>
										</li>
						...
						<script type = "text/javascript">
							$(function (guardar) {
								$('#altaUser').submit(function (guardar) {
									guardar.preventDefault()
									$('#ajax').load('registrar_usuario2.php?' + $('#altaUser').serialize())
								})
							})
						</script>
