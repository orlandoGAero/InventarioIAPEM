...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Registrar Bienes Informáticos</title>
			...
			<div id="contenido">
				...
				<div id="izquierda">
					...
					<div id="derecha">
						...
						<center>
							<fieldset> <legend> Registro de Bienes Informáticos</legend>
								<form name = 'altaNtec' action = '' method = 'POST' id = 'altaNtec' target = '_self'>
									<ul>
										...
										<li>
											...
											<?php
												include '../../librerias/conexion.php';
												$consulta = " 	SELECT IDeinformatico
																FROM equipos_informaticos
																ORDER BY IDeinformatico DESC LIMIT 1 ";
												$ejecutar = mysql_query($consulta) or die (mysql_error());
												$filas = mysql_num_rows($ejecutar);
													if ($filas==0)
													{
														$IDeTec = 1;
																...
																$IDeTec = mysql_result($ejecutar, 0, 'IDeinformatico');
																$IDeTec = $IDeTec+1;
															}
											...
											?>
										<li>
											<input type = 'text' name ='IDeinformatico' <?php echo "value = '$IDeTec' "; ?> readonly = 'readonly' size='30' class = 'rounded' />
										</li>
										...
										<li>
											<table border='0' align='left'>
												<tr>
													<td>
														<input type = 'text' name = 'equipo_informatico' size='30' class='rounded' onKeyUp = 'autoTec(this.value,tec)' />	
													</td>
													<td id ='tec' width='22'>  </td>
													<td> <a class = "tooltip" > <font size = '4' color = '#0000FF'>(?)</font> <span class="custom help"> <img src = "../../imagenes/Help.png" alt = "Help" height="35" width="35" />Ingresa el nombre del artículo, por ejemplo: </br> MONITOR<br>Teclado</span></a></td>
												</tr>
											</table>										
										</li>
						...
						<div id="ajax"></div>
							<script type="text/javascript">
								$(function (guardar) {
									$('#altaNtec').submit(function (guardar) {
										guardar.preventDefault()
										$('#ajax').load('registrar_tecnologias2.php?' + $('#altaNtec').serialize())
									})
								})
							</script>
