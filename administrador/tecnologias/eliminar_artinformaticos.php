...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Eliminar Bienes Informáticos</title>
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						...
						if ($band == 0) 
						{
							$eliminar = " 	DELETE FROM equipos_informaticos
											WHERE IDeinformatico = $IDeinformatico ";
							$ejecutar2 = mysql_query ($eliminar) or die (mysql_error());
							echo "Registro eliminado correctamente <br/>";
									...
									if ($activo == 'Si')
									{
										$actualizar = " UPDATE equipos_informaticos
														SET activo = 'No'
														WHERE IDeinformatico = $IDeinformatico ";
