...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Eliminar Inventario Bienes Informáticos</title>
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						...
						$codNuevoT = mysql_real_escape_string(quitar($_POST['codigoNuevoT']));
						...
						if ($motBaja == "")
						{
							...
							echo"<font size='4' face='Constantia Italic' text color='#ff8816'>Ingresa un motivo de la baja antes de continuar</font>
									...
									if ($band == 0)
									{
										$eliminar = " DELETE FROM tecnologias 
													  WHERE codigoNuevoT = '$codNuevoT'";
