...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Modificar Bienes Informáticos</title>
	...
	<body>
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha7">
					<div id="botones_sec">
						<a href="buscar_artInformaticos.php"><img src='../../imagenes/back.png' ALT="Regresar" TITLE="Regresar" vspace=4 hspace=4/></a>
					</div>
									...
									<?php
										...
										//print_r($_GET);
										$IDeinformatico = mysql_real_escape_string(quitar($_GET['IDeinformatico']));

												/*consulta para obtener el nombre de usuario que realizo la última modificación*/
													$consultaUs = "SELECT u.nombre,u.appat,u.ammat,equi.fecha_mod
																   FROM equipos_informaticos AS equi,usuarios AS u
																   WHERE equi.IDeinformatico=$IDeinformatico AND equi.IDusuario=u.IDusuario";
											...
											$consulta = " 	SELECT *
															...
															WHERE IDeinformatico = $IDeinformatico ";
											$ejecutar = mysql_query($consulta) or die (mysql_error());

											$IDeinformatico = mysql_result($ejecutar, 0, 'IDeinformatico');
											$nombreTec = mysql_result($ejecutar, 0, 'equipo_informatico');
					...
					<center>
						<fieldset><legend> Modificación de Bienes Informáticos </legend>
							<form name = 'modEinfor' method = 'POST' id = 'modEinfor' target = '_self'>
									<ul>
										<li>
											<label> Clave de Equipo </label>
										</li>
										<li>
											<input type = 'text' name = 'IDeinformatico' <?php echo "value = '$IDeinformatico' "; ?> readonly = 'readonly' size='30' class = 'rounded' />
										</li>
										...
										<li>
											<table border='0' align='left'>
												<tr>
													<td>
														<input type = 'text' name = 'equipo_informatico' <?php echo "value = '$nombreTec' "; ?> size='30' class='rounded' onKeyUp = 'autoTec(this.value,tec)'/>	
													</td>
													<td id ='tec' width='22'>  </td>
													<td> <a class = "tooltip" > <font size = '3' color = '#0000FF'>(?)</font> <span class="custom help"> <img src = "../../imagenes/Help.png" alt = "Help" height="35" width="35" />Ingresa el nombre del artículo, por ejemplo: MONITOR<br>Teclado</span></a></td>
												</tr>
											</table>										
										</li>
					...
					<div id="ajax"></div>
						<script type="text/javascript">
							$(function (modificar) {
								$('#modEinfor').submit(function (modificar) {
									modificar.preventDefault()
									$('#ajax').load('modificar_artinformaticos2.php?' + $('#modEinfor').serialize())
								})
							})
						</script>
				</div>
