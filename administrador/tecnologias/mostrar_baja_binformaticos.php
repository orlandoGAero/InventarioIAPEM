...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Bajas de Bienes Informáticos </title>
						...
						$filas2 = mysql_num_rows ($ejecutar2);
							if ($filas2==0)
							{
								echo"<br/><center><table><tr><td><img src='../../imagenes/icon_advertencia.png'/></td><td><font size='5' face='Constantia Italic' text color='#ff8816'>No se encontrarón registros</font></td></tr></table></center>";
										...
										echo"<br/><br/><font size='3' face='Georgia'><b>BAJAS DE BIENES INFORMÁTICOS</b></font><br/><br/>";
										echo "<div id = 'icon_excel'>
												<a href = '../../excel/admin/exl_baja_binformaticos.php'>
