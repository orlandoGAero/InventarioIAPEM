...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Buscar Inventario Bienes Informáticos</title>
		...
		<div id="contenedor">
			...
			<div id="contenido">
				...
				<div id="derecha4">
					...
					<center>
						<fieldset><legend>Búsqueda de Inventario Bienes Informáticos</legend>
							<form name = 'buscar' action = '' method = 'POST' class="formulariodemo1 cf">
							  ...
							  onkeyup="new Ajax.Updater('ajax','buscar_binformaticos2.php?buscar='+this.value, {method: 'POST' })">
