				...
				if ($filas==0) 
				{
					echo"<center><table><tr><td><img src='../../imagenes/icon_advertencia.png'/></td><td><font size='4' face='Constantia Italic' text color='#ff8816'>No exiten registros con el criterio tecleado</font></td></tr></table></center>";
							...
							echo "<div id = 'icon_excel'>
									<a href = '../../excel/admin/exl_binformaticos.php?$en_crit'>
												...
												<th> Acciones </th>
													...
													{ 
														...
														echo "<tr aling = 'center'>
																...
																<td> $activo </td>
																<td> $Inmueble </td>
																<td> <a href = 'modificar_binformaticos.php?$en_codNuevoT'><img src='../../imagenes/editar.png' TITLE='Modificar' /></a>
																	 <a href='eliminar_binformaticos.php?$en_codNuevoT2'><img src='../../imagenes/delete.png' TITLE='Eliminar' onclick='javascript:return asegurar();'/></a>
																</td>
															</tr>";
													}
									echo "</table></center>";
