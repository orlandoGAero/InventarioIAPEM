				...
				<div id="derecha">
					...
					<div id="botones_sec">
						...
						?>		
								<center>
									<fieldset>
										<legend> Eliminar o  Desactivar Inventario Bienes Informáticos </legend>
											<form action = 'eliminar_binformaticos2.php' method = 'POST'>
												<ul>
													<li>
														<input type = 'hidden' name = 'codigoNuevoT' <?php echo " value = '$codNuevoT' " ?> />
													</li>
