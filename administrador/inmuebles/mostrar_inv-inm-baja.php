...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Bajas de Bienes Inmuebles </title>
			...
			<div id="contenido">
				...
				<div id="derecha4">
					...
					<?php
						...
						$consulta = "SELECT bi.IDinmueble,bi.nombre_sede,bi.calle,bi.numero,bi.colonia,bi.cp,bi.ciudad,bi.telefono,bi.fecha_ingreso,bi.activo,bi.IDresguardatario,bi.IDest_adq,bi.motivo_baja,
						...
						$filas = mysql_num_rows($ejecutar);
							...
							{
								echo"<br/><br/><font size='3' face='Georgia'><b>BAJAS DE BIENES INMUEBLES</b></font><br/><br/>";
								echo "<div id='icon_excel'><a href='../../excel/admin/exl_baja-Inmuebles.php'><img src='../../imagenes/excel2013.png' TITLE='Ver Excel'/></a></div>";
								echo"<center>
