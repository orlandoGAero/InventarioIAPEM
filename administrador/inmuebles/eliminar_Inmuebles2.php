...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Eliminar Inventario Bienes Inmuebles</title>
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						include '../../librerias/conexion.php';
						$idInm = $_POST['idInm'];
						$motBaja = $_POST['motbaja'];
						$motBaja = utf8_decode($motBaja);
						$band = 0;
						...
						else
						{
							if($band == 0)
							{
							$consulta = "SELECT * FROM bienes_inmuebles WHERE IDinmueble='$idInm'";
							$ejecutar = mysql_query($consulta) or die (mysql_error());
							...
							if($band == 0)
							{
								 $consulta2 = "DELETE FROM bienes_inmuebles WHERE IDinmueble='$idInm";
							...
							else
							{
								...
								$consulta = "UPDATE bienes_inmuebles SET motivo_baja='$motBaja',activo='No' WHERE IDinmueble='$idInm'";
								$ejecutar = mysql_query($consulta) or die (mysql_error());
								
								$motBaja = utf8_encode($motBaja);
								echo"<img src='../../imagenes/advertencia.png'/><br/>";
