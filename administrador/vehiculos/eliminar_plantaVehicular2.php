...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="es">
	<head>
		<title>Eliminar Planta Vehícular</title>
			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					<?php
						...
						$codigoNuevoV = mysql_real_escape_string (quitar( $_POST['codigoNuevoV']));
						$motBaja = mysql_real_escape_string(quitar($_POST['motbaja']));
						$band = 0;
						
						if ($motBaja == "")
						{
							echo"<br/><img src='../../imagenes/advertencia.png' vspace=10/><br/>";							
							echo"<font size='4' face='Constantia Italic' text color='#ff8816'>Ingresa un motivo de la baja antes de continuar</font>
									<br/><br/><a href='javascript:history.back();'><img src='../../imagenes/reintentar.png'/></a>";
						} else {
									if ( $band == 0)
									{
										$consulta2 = " SELECT *
										...
										if($filas !=0)
										{
											echo"<br/><br/> <font size='4' face='Constantia Italic' text color='#FF8000'>No se puede eliminar el registro...porque es utilizado por otra tabla </font> <br/>";
											$band = 1;
										}
									}
									...
									if ( $band == 0)
									{
										$eliminar = " DELETE FROM planta_vehicular
													  WHERE codigoNuevoV = '$codigoNuevoV'";
										$ejecutar3 = mysql_query($eliminar) or die (mysql_error());
										echo "<br/><font size='5' face='time new roman' text color='#FF8000'>Registro eliminado correctamente</font><br/>";
									
									} else {
												$motBaja = mb_strtoupper($motBaja);
									
												$actualizar = " UPDATE planta_vehicular
																SET motivo_baja = '$motBaja',activo = 'No' 
																WHERE codigoNuevoV = '$codigoNuevoV'";
												$ejecutar4 = mysql_query($actualizar) or die (mysql_error());
												
												$motBaja = utf8_encode($motBaja);
												echo"<img src='../../imagenes/advertencia.png' vspace=10/><br/>";
												echo"<center><table><tr><td><img src='../../imagenes/icon_palomita.png'/></td><td><font size='4' face='Constantia Italic' text color='#8edc48'>El registro no se elimina solo se desactiva</font></td></tr></table></center>";
											}
								}
					?>
