			...
			<div id="contenido">
				...
				<div id="derecha">
					...
					?>
							...
							<center>
								<fieldset>
									<legend> Eliminar o Desactivar Planta Vehicular </legend>
										<form action = 'eliminar_plantaVehicular2.php' method = 'POST'>
											<ul>
												<li>
													<input type = 'hidden' name = 'codigoNuevoV' <?php echo " value = '$codigoNuevoV' " ?> />
												</li>
